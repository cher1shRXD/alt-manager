...
const Sidebar = async () => {
  ...
  return (
    <div className="w-[var(--sidebar-width)] fixed bottom-4  xl:top-4 xl:left-4 xl:h-[calc(100vh-32px)] bg-container border border-border rounded-xl backdrop-blur-xs p-2 flex xl:flex-col xl:gap-1">
