  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-2 bg-container border border-border p-4 rounded-lg">
        ...
        <input type="text" className="w-full min-w-56 p-2 text-sm rounded-lg bg-container border border-border outline-none mt-1" onChange={handleNewTitle} value={newTitle} placeholder={workspaceName} />
