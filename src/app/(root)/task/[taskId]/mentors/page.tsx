  ...
  return (
    <div className="w-full flex flex-col gap-4 mb-16">
      ...
      <div className="w-full p-2 bg-container rounded-xl border border-border flex flex-col gap-4 items-start mb-8">
        <p className="p-2 w-full bg-container border border-border rounded-lg lg:text-xl">
          {task.title}
        </p>
        <textarea
          value={task.description}
          readOnly
          className="w-full outline-none min-h-80 p-2 resize-none bg-container border border-border rounded-lg text-sm lg:text-base"
        />
