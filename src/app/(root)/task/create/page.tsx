  ...
  return (
    <div className="w-full mx-auto lg:p-4">
      ...
      <form
        ...
        <input
          className="border border-border  p-2 rounded-lg bg-container outline-none text-sm lg:text-base"
          placeholder="제목"
        ...
        />
        <textarea
          className="border border-border  p-2 rounded-lg bg-container resize-none h-40 outline-none text-sm lg:text-base"
          placeholder="설명"
        ...
        <div className="flex flex-col gap-2">
          <div className="w-full flex lg:gap-2 flex-col lg:flex-row lg:items-center relative">
